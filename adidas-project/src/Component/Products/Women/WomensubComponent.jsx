...
const WomensubComponent = (props) => {
  const data1 = [
    {
      image:
        "https://assets.adidas.com/images/w_280,h_280,f_auto,q_auto:sensitive/b648d8e1aa6141989598ae6a000b6e74_9366/super-sleek-3-strap-shoes.jpg",
      category: "SNEAKERS",
    },
    {
      image:
        "https://assets.adidas.com/images/w_280,h_280,f_auto,q_auto:sensitive/f50979b8e645411096c6ae1a00aac728_9366/essentials-yoga-rib-tank-top.jpg",
      category: "Tops",
    },
    {
      image:
        "https://assets.adidas.com/images/w_280,h_280,f_auto,q_auto:sensitive/94f30481e99f4318b125ae9f00c2675a_9366/optime-7-8-t.jpg",
      category: "TIGHTS",
    },
    {
      image:
        "https://assets.adidas.com/images/w_280,h_280,f_auto,q_auto:sensitive/b8fbe2d1b9f945008cddad58009cb1a8_9366/adicolor-classics-corded-velour-oversize-sweatshirt.jpg",
  ...
  return (
    <>
      ...
      <div className="women-category">
        {data1.map((el) => (
          <div className="women-container" onClick={onAdd}>
